  ...
  return (
    <div className={`${props.size} flex flex-col mt-2 relative`}>
      ...
      {shouldDropdownVisible && (
        <div className="w-full max-h-150 absolute overflow-y-scroll bg-white  shadow-md border-1 top-14 z-40">
          {itemList?.map((item, index) => (
            <h6
              key={index}
              className="text-xs py-1 px-2 hover:bg-darkfs hover:text-gray-100 cursor-pointer relative"
